...
//                .then(getPipelineOutput(false)), this));
        SmartDashboard.setDefaultNumber("PointDrive/min", 0.4);
        SmartDashboard.setDefaultNumber("PointDrive/max", 5);
        SmartDashboard.setDefaultNumber("PointDrive/outScalar", 10);
        SmartDashboard.setDefaultNumber("PointDrive/P", 0.7);
        SmartDashboard.setDefaultNumber("PointDrive/I", 0);
        SmartDashboard.setDefaultNumber("PointDrive/D", 2);
        SmartDashboard.setDefaultNumber("PointDrive/deadZone", 0.01);
