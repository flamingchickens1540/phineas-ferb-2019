...
public class PurePursuitToVisionTarget2 extends Command {

    public static final Logger logger = Logger.getLogger(PurePursuitToVisionTarget2.class);
    ...
    public PurePursuitToVisionTarget2(DeepSpaceVisionTargetLocalization deepSpaceVisionTargetLocalization, TankDriveOdometryRunnable driveOdometry) {
    ...
    public PurePursuitToVisionTarget2(DeepSpaceVisionTargetLocalization deepSpaceVisionTargetLocalization, TankDriveOdometryRunnable driveOdometry, Runnable onFail) {
