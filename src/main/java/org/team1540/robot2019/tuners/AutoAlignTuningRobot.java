...
//    nt.getTable("Drivetrain/Debug/Position").getEntry("Left").setNumber(drivetrain.getLeftPositionTicks());
//    nt.getTable("Drivetrain/Debug/Position").getEntry("Right").setNumber(drivetrain.getRightPositionTicks());
//  }
//
//  @Override
