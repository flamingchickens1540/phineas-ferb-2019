...
public class PercentManualLineupSequence extends CommandGroup {
    ...
    public PercentManualLineupSequence() {
        ...
        SmartDashboard.setDefaultNumber("PercentLineup/ANGULAR_KP", 0.2); // TODO: Remove temporary tuning (yaml ftw)
        SmartDashboard.setDefaultNumber("PercentLineup/ANGULAR_KI", 0);
        SmartDashboard.setDefaultNumber("PercentLineup/ANGULAR_KD", 0.5);
        SmartDashboard.setDefaultNumber("PercentLineup/MIN_VEL_THETA", 0);
        SmartDashboard.setDefaultNumber("PercentLineup/MAX_VEL_THETA", 10);
        SmartDashboard.setDefaultNumber("PercentLineup/DEADZONE_VEL_THETA", 0.05);
        SmartDashboard.setDefaultNumber("PercentLineup/OUTPUT_SCALAR", 20);
    }
    ...
    protected void initialize() {
        ...
        PercentManualLineup.OUTPUT_SCALAR = SmartDashboard.getNumber("PercentLineup/OUTPUT_SCALAR", 0);
