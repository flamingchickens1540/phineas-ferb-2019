...
public class Transform2D {
  ...
  public Transform2D add(Transform2D other) {
    ...
    Transform3D transform3D = new Transform3D(thisTransform3D.getOrientation().applyInverseTo(otherTransform3D.getPosition()).add(thisTransform3D.getPosition()), thisTransform3D.getOrientation().applyTo(otherTransform3D.getOrientation()));
