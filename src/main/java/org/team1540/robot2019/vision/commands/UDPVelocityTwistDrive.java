...
//    pipeline.execute();
    ...
    protected boolean isFinished() {
        ...
        double angleError = TrigUtils
            .signedAngleError(goal.getTheta(), Math.toRadians(-Robot.navx.getYaw())); // TODO: If this is the proper way to calculate signed angle, this should be moved to the TrigUtils class
